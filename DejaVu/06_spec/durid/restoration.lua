...
insert(macroList, { title = "player共生关系", key = "SHIFT-NUMPAD1", text = "/cast [@player] 共生关系" })
insert(macroList, { title = "party1共生关系", key = "SHIFT-NUMPAD2", text = "/cast [@party1] 共生关系" })
insert(macroList, { title = "party2共生关系", key = "SHIFT-NUMPAD3", text = "/cast [@party2] 共生关系" })
insert(macroList, { title = "party3共生关系", key = "SHIFT-NUMPAD4", text = "/cast [@party3] 共生关系" })
insert(macroList, { title = "party4共生关系", key = "SHIFT-NUMPAD5", text = "/cast [@party4] 共生关系" })
insert(macroList, { title = "player生命绽放", key = "SHIFT-NUMPAD6", text = "/cast [@player] 生命绽放" })
insert(macroList, { title = "party1生命绽放", key = "SHIFT-NUMPAD7", text = "/cast [@party1] 生命绽放" })
insert(macroList, { title = "party2生命绽放", key = "SHIFT-NUMPAD8", text = "/cast [@party2] 生命绽放" })
insert(macroList, { title = "party3生命绽放", key = "SHIFT-NUMPAD9", text = "/cast [@party3] 生命绽放" })
insert(macroList, { title = "party4生命绽放", key = "SHIFT-NUMPAD0", text = "/cast [@party4] 生命绽放" })
insert(macroList, { title = "player野性成长", key = "ALT-F2", text = "/cast [@player] 野性成长" })
insert(macroList, { title = "party1野性成长", key = "ALT-F3", text = "/cast [@party1] 野性成长" })
insert(macroList, { title = "party2野性成长", key = "ALT-F5", text = "/cast [@party2] 野性成长" })
insert(macroList, { title = "party3野性成长", key = "ALT-F6", text = "/cast [@party3] 野性成长" })
insert(macroList, { title = "party4野性成长", key = "ALT-F7", text = "/cast [@party4] 野性成长" })
insert(macroList, { title = "player愈合", key = "ALT-F8", text = "/cast [@player] 愈合" })
insert(macroList, { title = "party1愈合", key = "ALT-F9", text = "/cast [@party1] 愈合" })
insert(macroList, { title = "party2愈合", key = "ALT-F10", text = "/cast [@party2] 愈合" })
insert(macroList, { title = "party3愈合", key = "ALT-F11", text = "/cast [@party3] 愈合" })
insert(macroList, { title = "party4愈合", key = "ALT-F12", text = "/cast [@party4] 愈合" })
insert(macroList, { title = "player回春术", key = "SHIFT-F2", text = "/cast [@player] 回春术" })
insert(macroList, { title = "party1回春术", key = "SHIFT-F3", text = "/cast [@party1] 回春术" })
insert(macroList, { title = "party2回春术", key = "SHIFT-F5", text = "/cast [@party2] 回春术" })
insert(macroList, { title = "party3回春术", key = "SHIFT-F6", text = "/cast [@party3] 回春术" })
insert(macroList, { title = "party4回春术", key = "SHIFT-F7", text = "/cast [@party4] 回春术" })
insert(macroList, { title = "树皮术", key = "SHIFT-F8", text = "/cast 树皮术" })
insert(macroList, { title = "万灵之召", key = "SHIFT-F9", text = "/cast 万灵之召" })
insert(macroList, { title = "宁静", key = "SHIFT-F10", text = "/cast 宁静" })
insert(macroList, { title = "自然迅捷", key = "SHIFT-F11", text = "/cast 自然迅捷" })
insert(macroList, { title = "迅捷治愈", key = "SHIFT-F12", text = "/cast 迅捷治愈" })
insert(macroList, { title = "target斜掠", key = "CTRL-NUMPAD1", text = "/cast [@target] 斜掠" })
insert(macroList, { title = "target撕碎", key = "CTRL-NUMPAD2", text = "/cast [@target] 撕碎" })
insert(macroList, { title = "target割裂", key = "CTRL-NUMPAD3", text = "/cast [@target] 割裂" })
insert(macroList, { title = "target野性之心", key = "CTRL-NUMPAD4", text = "/cast 野性之心" })
insert(macroList, { title = "target月火术", key = "CTRL-NUMPAD5", text = "/cast [@target] 月火术" })
insert(macroList, { title = "target愤怒", key = "CTRL-NUMPAD6", text = "/cast [@target] 愤怒" })
insert(macroList, { title = "激活", key = "CTRL-NUMPAD7", text = "/cast [@player] 激活" })
insert(macroList, { title = "mouseover复生", key = "CTRL-NUMPAD8", text = "/cast [@mouseover] 复生" })
